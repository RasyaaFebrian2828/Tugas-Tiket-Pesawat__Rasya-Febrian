...
<head>
    ...
    <title>Daftar Penerbangan - Admin Panel</title>
...
<header class="bg-red-600 p-4 text-white sticky top-0 z-40 shadow-md">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav class="hidden md:flex items-center gap-6">
            ...
            <a href="#" class="font-medium hover:text-red-100 transition-colors">Pengaturan</a>
        </nav>
    ...
    <div id="mobileMenu" class="mobile-menu closed md:hidden bg-red-600 mt-2 py-3 px-4 rounded-lg shadow-lg">
        <nav class="flex flex-col gap-3">
            ...
            <a href="#" class="font-medium hover:text-red-100 transition-colors py-1">Pengaturan</a>
...
<main class="p-6 flex-1 max-w-7xl mx-auto w-full">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div class="flex items-center gap-4">
            <div class="relative">
                <input type="text" placeholder="Cari penerbangan..." class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
        ...
        <a href="{{ route('admin.penerbangan.create') }}" class="btn btn-primary">
            ...
            <table class="w-full border-collapse">
                <thead>
                    <tr class="bg-gray-100 text-left">
                        ...
                        <th class="p-4 font-semibold text-gray-700">Maskapai</th>
                        <th class="p-4 font-semibold text-gray-700">Asal</th>
                        <th class="p-4 font-semibold text-gray-700">Tujuan</th>
                        <th class="p-4 font-semibold text-gray-700">Berangkat</th>
                        <th class="p-4 font-semibold text-gray-700">Tiba</th>
                        <th class="p-4 font-semibold text-gray-700">Harga</th>
                        <th class="p-4 font-semibold text-gray-700">Kursi</th>
                ...
                <tbody>
                    @foreach($penerbangans as $p)
                        <tr class="border-t border-gray-200 hover:bg-gray-50 transition-colors">
                            ...
                            <td class="p-4">{{ $p->waktu_tiba }}</td>
                            <td class="p-4 font-semibold text-red-600">Rp {{ number_format($p->harga,0,',','.') }}</td>
                            <td class="p-4">
                                <span class="px-3 py-1 text-sm font-semibold rounded-full 
                                    {{ $p->kursi_tersedia > 20 ? 'bg-green-100 text-green-800' : ($p->kursi_tersedia > 10 ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800') }}">
                                    {{ $p->kursi_tersedia }}
                                </span>
                            </td>
                            <td class="p-4 text-center">
                                <div class="flex justify-center space-x-2">
                                    ...
                                    <form action="{{ route('admin.penerbangan.destroy',$p->id) }}" method="POST" class="inline-block"
                                          onsubmit="return confirm('Hapus data ini?')">
                                      @csrf
                                      @method('DELETE')
                                      <button class="btn btn-primary btn-sm bg-red-600 border-red-600 hover:bg-red-700 hover:border-red-700">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Laporan</a></li>
                </ul>
            </div>
...
<div class="mobile-bottom-nav md:hidden">
    ...
    <a href="{{ route('admin.penerbangan.index') }}" class="mobile-nav-item active">
