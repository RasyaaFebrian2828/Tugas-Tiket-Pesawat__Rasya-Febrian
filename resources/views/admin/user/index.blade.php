...
<header class="bg-red-600 p-4 text-white sticky top-0 z-40 shadow-md">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav class="hidden md:flex items-center gap-6">
            ...
            <a href="#" class="font-medium hover:text-red-100 transition-colors">Kelola Penerbangan</a>
    ...
    <div id="mobileMenu" class="mobile-menu closed md:hidden bg-red-600 mt-2 py-3 px-4 rounded-lg shadow-lg">
        <nav class="flex flex-col gap-3">
            ...
            <a href="#" class="font-medium hover:text-red-100 transition-colors py-1">Kelola Penerbangan</a>
...
<main class="p-6 flex-1 max-w-7xl mx-auto w-full">
    <div class="mb-8">
        <h1 class="text-2xl md:text-3xl font-bold text-gray-800 mb-2">Kelola User</h1>
        <p class="text-gray-600">Kelola data pengguna sistem Lion Air</p>
    </div>
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div class="flex items-center gap-4">
            <div class="relative">
                <input type="text" placeholder="Cari user..." class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
            ...
            <table class="w-full border-collapse">
                <thead>
                    <tr class="bg-gray-100 text-left">
                        <th class="p-4 text-center font-semibold text-gray-700">#</th>
                        <th class="p-4 font-semibold text-gray-700">Nama</th>
                        <th class="p-4 font-semibold text-gray-700">Email</th>
                        <th class="p-4 text-center font-semibold text-gray-700">Role</th>
                        ...
                        <tr class="border-t border-gray-200 hover:bg-gray-50 transition-colors">
                            ...
                            <td class="p-4 text-center">
                                <div class="flex justify-center space-x-2">
                                    ...
                                    <form action="{{ route('admin.user.destroy', $u) }}" method="POST" class="inline-block"
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Kelola Penerbangan</a></li>
...
<div class="mobile-bottom-nav md:hidden">
    ...
    <a href="{{ route('admin.user.index') }}" class="mobile-nav-item active">
