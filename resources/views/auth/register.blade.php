...
<main class="flex-1 flex items-center justify-center py-16 px-4">
  <div class="bg-white rounded-xl shadow-md card-hover w-full max-w-md overflow-hidden search-box">
    <div class="hero-gradient p-8 text-center text-white">
      <h1 class="text-2xl md:text-3xl font-bold mb-2">Buat Akun Baru</h1>
      <p class="text-white/80 text-sm">Daftar untuk mulai memesan penerbangan Anda</p>
    </div>
    ...
    <div class="p-8">
      ...
      <div class="mt-8 pt-6 border-t border-gray-200">
        <p class="text-center text-sm text-gray-600">
          Sudah punya akun? 
          <a href="{{ route('login') }}" class="text-red-600 hover:text-red-700 font-medium transition-colors">Login di sini</a>
        </p>
      </div>
    </div>
  </div>
